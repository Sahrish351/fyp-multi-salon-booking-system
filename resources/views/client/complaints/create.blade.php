...
@section('title', 'Submit Complaint — Beauty Blush Salons')
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-exclamation-circle" style="color:#FF6B9D;"></i> Submit Complaint</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('client.complaints.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <label for="appointment_id"><i class="fas fa-calendar-check" style="color:#FF6B9D;"></i> Select Appointment <span class="text-danger">*</span></label>
                            <div class="position-relative">
                                ...
                                <span style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); pointer-events: none; color: #FF6B9D; font-size: 14px;">
                        ...
                        {{-- ============================================ --}}
                        <div class="form-group mb-3">
                            <label for="type"><i class="fas fa-tag" style="color:#FF6B9D;"></i> Complaint Type <span class="text-danger">*</span></label>
                            <div class="position-relative">
                        ...
                        {{-- ============================================ --}}
                        <div class="form-group mb-3">
                            <label for="complaintSubject"><i class="fas fa-heading" style="color:#FF6B9D;"></i> Subject <span class="text-danger">*</span></label>
                            <div class="position-relative">
                        ...
                        <div class="form-group mb-3" id="customSubjectWrapper" style="display:none;">
                            <label for="customSubject"><i class="fas fa-pen" style="color:#FF6B9D;"></i> Please specify</label>
                        ...
                        {{-- ============================================ --}}
                        <div class="form-group mb-3">
                            <label for="description"><i class="fas fa-align-left" style="color:#FF6B9D;"></i> Description <span class="text-danger">*</span></label>
                        ...
                        {{-- ============================================ --}}
                        <div class="form-group mb-3">
                            <label for="image"><i class="fas fa-image" style="color:#FF6B9D;"></i> Attachment <span class="text-muted">(Optional)</span></label>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn" style="background:#FF6B9D;color:#fff;border:none;border-radius:50px;padding:10px 30px;font-weight:600;">
