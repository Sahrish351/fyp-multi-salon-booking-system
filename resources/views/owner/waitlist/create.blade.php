            ...
            <div class="col-12">
                <div class="panel-card">
                    ...
                    <textarea name="notes" class="form-control input-custom" rows="3"
                              placeholder="Any specific preferences, e.g. preferred stylist or time of day..."></textarea>
