                        ...
                        <div class="col-12">
                            ...
                            <select name="client_id" class="form-select input-custom" required>
                                @foreach ($clients ?? [] as $client)
                                    <option value="{{ $client->id }}" {{ $entry['client_id'] == $client->id ? 'selected' : '' }}>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <select name="service_id" class="form-select input-custom" required>
                                @foreach ($services ?? [] as $service)
                                    <option value="{{ $service->id }}" {{ $entry['service_id'] == $service->id ? 'selected' : '' }}>
                                        {{ $service->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <select name="stylist_id" class="form-select input-custom">
                                ...
                                @foreach ($stylists ?? [] as $stylist)
                                    <option value="{{ $stylist->id }}" {{ $entry['stylist_id'] == $stylist->id ? 'selected' : '' }}>
                                        {{ $stylist->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <input type="number" name="position" class="form-control input-custom"
                                   value="{{ $entry['position'] }}" min="1" required>
                        </div>
                    </div>
                </div>
            </div>
