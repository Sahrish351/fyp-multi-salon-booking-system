                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control input-custom"
                                   placeholder="e.g. Premium Haircut" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="price" class="form-control input-custom"
                                   placeholder="85" min="0" step="0.01" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="discount_price" class="form-control input-custom"
                                   placeholder="75" min="0" step="0.01">
                        </div>

                        <div class="col-12">
                            <label class="form-label-custom">Short Description</label>
                            <textarea name="description" class="form-control input-custom" rows="4"
                                      placeholder="Describe what this service includes, benefits, what makes it special..."></textarea>
                        </div>

                        <div class="col-12">
                            <label class="form-label-custom">Notes for Clients <span class="text-muted">(optional)</span></label>
                            <textarea name="client_notes" class="form-control input-custom" rows="2"
                                      placeholder="e.g. Please arrive 10 minutes early. Not recommended during pregnancy."></textarea>
                        </div>
