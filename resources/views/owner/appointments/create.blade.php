...
@section('content')
    ...
    <div class="page-header d-flex justify-content-between align-items-start flex-wrap gap-3">
        <div>
            ...
            <p>Book a new appointment for a client</p>
        </div>
                ...
                <div class="panel-card">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-3">
                            ...
                            <input type="time" name="start_time" class="form-control input-custom" required>
                        </div>
                        <div class="col-3">
                            <label class="form-label-custom">End Time</label>
                            <input type="time" name="end_time" class="form-control input-custom" required>
                        </div>
                    </div>
                </div>
            </div>
