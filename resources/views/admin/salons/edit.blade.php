...
@section('title', 'Edit Salon - ' . $salon->name)
...
<style>
    ...
    /* ── Status Badge on Select ── */
    .status-hint { font-size: 0.75rem; color: var(--gl-text-lt); margin-top: 2px; }
    ...
    .current-logo-wrap { display: flex; align-items: center; gap: 12px; margin-bottom: 10px; }
    .current-logo-wrap img { width: 70px; height: 70px; object-fit: cover; border-radius: 12px; border: 2px solid var(--gl-border); }
    .current-logo-label { font-size: 0.75rem; color: var(--gl-text-lt); font-weight: 600; }
...
<div class="page-header-row">
    <div>
        <h1>Edit Salon</h1>
        <p>Update the details for <strong>{{ $salon->name }}</strong></p>
    </div>
        ...
        <form action="{{ route('admin.salons.update', $salon->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name"
                        ...
                        placeholder="e.g., Glamora Gulberg" required>
                    ...
                    <select name="owner_id" id="owner_id"
                        ...
                        @foreach($owners as $owner)
                            <option value="{{ $owner->id }}"
                                {{ old('owner_id', $salon->owner_id) == $owner->id ? 'selected' : '' }}>
                ...
                <div class="form-group full">
                    ...
                    <input type="text" name="address" id="address"
                        ...
                        placeholder="Complete street address" required>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email"
                        ...
                        placeholder="salon@example.com" required>
                ...
                <div class="form-group full">
                    ...
                    <div class="file-upload-wrap">
                        ...
                        <div class="current-logo-wrap">
                            <img src="{{ asset('storage/' . $salon->logo) }}" alt="Current Logo">
                        ...
                        <input type="file" name="logo" id="logo"
                            ...
                            accept="image/*">
                        <span class="file-hint"><i class="fas fa-info-circle"></i> Supported: JPG, PNG, GIF — Max 2MB. Upload new to replace current.</span>
            ...
            <div class="form-actions">
                <button type="submit" class="btn-save">
                    <i class="fas fa-save"></i> Update Salon
                </button>
