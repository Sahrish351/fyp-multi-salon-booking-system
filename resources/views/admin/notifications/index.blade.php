...
.btn-mark-all {
    ...
    background:linear-gradient(135deg,var(--pk),#E85588); color:#fff; border:none; font-weight:700; font-size:.84rem;
}
...
.notif-type-badge {
    ...
    padding:2px 10px; border-radius:20px; background:var(--pk-lt); color:#E85588; margin-left:8px;
}
