            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background: #ffffff; border-radius: 20px; box-shadow: 0 8px 30px rgba(0,0,0,0.08); padding: 40px; border: 1px solid #fce4ec;">
                ...
                <tr>
                    <td align="center" style="padding-bottom: 30px;">
                        <div style="width: 70px; height: 70px; border-radius: 50%; background: #fef2f2; display: inline-flex; align-items: center; justify-content: center; font-size: 32px;">
                            ❌
                        </div>
                        <h1 style="font-family: 'Playfair Display', serif; color: #dc2626; font-size: 28px; margin: 16px 0 8px; font-weight: 700;">
                            Appointment Cancelled
                        </h1>
                        <p style="color: #8a7a88; font-size: 16px; margin: 0;">
                            Your appointment at {{ $salon->name }} has been cancelled.
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding-top: 30px; text-align: center;">
                        ...
                        <p style="color: #8a7a88; font-size: 13px; margin: 0;">
                            Need help? Contact us at <a href="mailto:{{ $salon->email }}" style="color: #E91E8C; text-decoration: none;">{{ $salon->email }}</a>
                        </p>
