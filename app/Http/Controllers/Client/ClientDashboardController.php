...
class ClientDashboardController extends Controller
{
    public function index()
    {
        try {
            ...
            $alertsCount = $client->unreadNotifications()->count();
            ...
            $stats = [
                ...
                'favorite_salons' => $favoritesCount,
                'total'           => $totalBookings,
            ...
            if (Schema::hasTable('payments') && Schema::hasColumn('payments', 'amount')) {
                $paidAmount = (float) Payment::whereHas(
                    'appointment',
            ...
            if (Schema::hasTable('payments')) {
                $recentPayments = Payment::with('appointment.salon')
            ...
            \Log::error('Client Dashboard Error: ' . $e->getMessage());
